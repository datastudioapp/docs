...
["tabulardata" algorithm folder](https://github.com/datastudioapp/helloworld-datakit/tree/main/tabulardata).
...
```json title="tabulardata/algorithm.json" ins={16,20}
{
  "name": "tabulardata",
...
```bash
ds reset  # Remember to reset to remove any previous runs of our algorithm
ds init tabulardata
ds load data data/tabulardata2.csv
```
