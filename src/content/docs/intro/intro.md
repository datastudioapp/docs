...
description: An introduction to DataStudio datakits
---

In DataStudio, a datakit is a structured way to organise and bundle a data
...
[command line tool](https://github.com/datastudioapp/cli). Each execution is
