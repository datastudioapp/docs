...
By default, algorithms in a datakit are executed in the [`python-run-base`](https://github.com/datastudioapp/python-run-base) Docker container,
which provides commonly used libraries such as `numpy` and `pandas`. If you need
a library not included in this default container, you can easily extend it and create a custom
